...
Gift items straight from your inventory to another member — no coins change hands, the items simply move. Gifting also counts toward the daily **gift** quest when it's on your [quest board](/economy/progression#daily-quests).
