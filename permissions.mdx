---
title: "Discord Permissions Percy Needs to Function"
sidebarTitle: "Permissions"
description: "A complete breakdown of the Discord permissions Percy needs for each feature, and tips for granting them safely and correctly."
---
...
<Note>
  Temporary bans, mutes, and lockdowns all run on Percy's internal timer system — they will fire at the correct time even after a bot restart, as long as Percy still has the required permissions when the timer expires.
</Note>
