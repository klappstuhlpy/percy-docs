---
title: "Percy: The All-in-One Discord Bot for Your Server"
sidebarTitle: "Introduction"
description: "Percy is a feature-rich, multipurpose Discord bot covering moderation, economy, music, leveling, and more — all in one invite."
---
...
<CardGroup cols={2}>
  <Card title="Moderation & Safety" icon="shield-halved" href="/moderation/overview">
    Kick, ban, mute, purge, lockdown, auto-moderation rules, raid protection, captcha verification (Sentinel), audit logging, and more — all backed by a persistent timer system that survives restarts.
  </Card>
  ...
  <Card title="Music" icon="music" href="/music/overview">
    High-quality audio from Spotify, Apple Music, and SoundCloud. Includes a persistent now-playing panel, 24/7 always-on mode, curated radio presets, lyrics, and personal playlists.
  </Card>
