---
title: "Moderation Commands and Tools in Percy"
...
| `/selfmute` | Lets you voluntarily mute yourself for between 5 minutes and 24 hours. | — (any member) |
| `/muterole` | Opens the interactive mute-role configuration dashboard. | Manage Roles + Manage Channels |
...
```
/mute @User#1234 10m Cooldown
```

<Note>
  Use `/tempmute` for a mute that automatically expires. `/mute` applies the role indefinitely until you manually run `/unmute`.
</Note>
