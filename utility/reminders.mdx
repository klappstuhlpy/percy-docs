...
```
/reminder create <time> <message> [flags]
```
...
<Accordion title="--dm / --pm">
  ...
  ```
  /reminder create 1h "Check your email" --dm
  ```
...
<Accordion title="--every <interval>">
  ...
  ```
  /reminder create 8am "Morning stand-up" --every 1d
  ```
</Accordion>
...
<Accordion title="--count / --times <n>">
  ...
  ```
  /reminder create 8am "Morning stand-up" --every 1d --count 5
  ```
</Accordion>
...
<Accordion title="--share / --with @User1 @User2 …">
  ...
  ```
  /reminder create 30m "Pizza's ready" --share @Alice @Bob
  ```
</Accordion>
...
| Command | Description |
|---|---|
| `/reminder create <time> <message> [flags]` | Create a new reminder |
...
```
/reminder create 2h "Submit the report"
```
Pings you in 2 hours with "Submit the report".

```
/reminder create "next monday at 9am" "Team standup" --dm
```
...
```
/reminder create 30m "Check the oven" --share @Alice @Bob
```
