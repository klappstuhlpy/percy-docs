...
description: "Configure Percy to automatically reply when a message matches a keyword, exact phrase, or regular expression in your server."
---
...
| `/autoresponder toggle <trigger> <enabled>` | Enable or disable an autoresponder without deleting it |
