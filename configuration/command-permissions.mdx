---
title: "Command Permissions: Enable and Disable Commands"
...
<Note>
  Commands in the **Config** and **Admin** categories cannot be disabled through this system. Percy always responds to `/config`, `/prefix`, and related admin commands so you can never lock yourself out of the bot's settings.
</Note>
