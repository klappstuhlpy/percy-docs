---
title: "Server Setup: Configure Percy for Your Community"
...
<Note>
  Config and Admin cog commands can never be disabled through the command-permission system, so you can always reach `/config` and `/prefix` even if other commands have been restricted.
</Note>
